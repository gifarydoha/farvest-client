  ...
  return (
    <>
      ...
      <section className="mx-auto px-5 py-20 sm:px-10 md:px-12 lg:max-w-7xl lg:px-5">
        <main>
          <section className="w-full xl:py-24 lg:py-20 py-12  border-gray-300">
              ...
              <div className="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
                <div>
                  ...
                  <div className="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                    <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-emerald-600">
                      <a
                        href="javascript:;"
                        className="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                      >
                        <svg
                          className="fill-white transition-all duration-500 group-hover:fill-emerald-600"
                          width="30"
                          height="30"
                          viewBox="0 0 30 30"
                          fill="none"
                      ...
                      <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                        Feel free to adjust any part of it to better fit your
                        style or specific messaging!
                      </p>
                    </div>
                    <div className="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-emerald-600">
                      <a
                      ...
                      >
                        <svg
                          className="stroke-white transition-all duration-500 group-hover:stroke-emerald-600"
                          width="30"
                          height="30"
                          viewBox="0 0 30 30"
                          fill="none"
                      ...
                      <h5 className="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">
                        Farvest farmers Choice
                      </h5>
                      <p className="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">
                        We prioritize the security of our users, ensuring that
                        all transactions related to post-harvest loss reduction
                        solutions are carried out safely and efficiently.
                      </p>
                    </div>
                  </div>
                  {/* <div className="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                    <div className="flex gap-x-1 border-r border-emerald-300 items-center">
                      <svg
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                      ...
                      <a
                        href="javascript:;"
                        className="text-emerald-900 text-lg font-normal leading-7 pl-2.5 pr-3.5"
                      >
                        4.9 Rating
                      </a>
                    </div>
                    <a
                      href="javascript:;"
                      className="pl-3.5 text-emerald-900 text-lg font-normal leading-7"
                    >
                      163 Reviews on{" "}
                ...
                <form
                  ...
                  className="bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg mx-auto"
                >
                  <div className="relative mb-8">
                    ...
                    <input
                      ...
                      className="w-full block h-12 pr-5 pl-12 py-2.5 text-lg shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full focus:outline-none"
                  ...
                  <div className="relative mb-8">
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="block w-full h-40 px-4 py-2.5 text-lg shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-2xl focus:outline-none resize-none"
                  ...
                  <button
                    type="submit"
                    className="w-full h-12 rounded-full bg-emerald-600 hover:bg-emerald-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center"
                  >
                    Send message
                  </button>
                  {status && (
