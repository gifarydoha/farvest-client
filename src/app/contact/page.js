  ...
  return (
    <>
      ...
      <section className=" mx-auto px-5 py-20 sm:px-10 md:px-12 lg:max-w-7xl lg:px-5">
        <>
          <main>
            <section class="w-full xl:py-24 lg:py-20 py-12  border-b border-gray-300">
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
                  <div>
                    ...
                    <div class="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                      <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-emerald-600">
                        <a
                          href="javascript:;"
                          class="w-14 h-14 bg-emerald-600 rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer"
                        >
                          <svg
                            class="fill-white transition-all duration-500 group-hover:fill-emerald-600"
                            width="30"
                            height="30"
                            viewBox="0 0 30 30"
                            fill="none"
                      ...
                      <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-emerald-600">
                        ...
                        >
                          <svg
                            class="stroke-white transition-all duration-500 group-hover:stroke-emerald-600"
                            width="30"
                            height="30"
                            viewBox="0 0 30 30"
                            fill="none"
                    ...
                    <div class="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                      <div class="flex gap-x-1 border-r border-emerald-300 items-center">
                        <svg
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                        ...
                        <a
                          href="javascript:;"
                          class="text-emerald-900 text-lg font-normal leading-7 pl-2.5 pr-3.5"
                        >
                          4.9 Rating
                        </a>
                      </div>
                      <a
                        href="javascript:;"
                        class="pl-3.5 text-emerald-900 text-lg font-normal leading-7"
                      >
                        163 Reviews on{" "}
                  ...
                  >
                    ...
                    <button class="w-full h-12 rounded-full bg-emerald-600 hover:bg-emerald-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">
                      Send message{" "}
                      <svg
                        width="20"
                        height="20"
            ...
            <section class="w-full xl:py-28 lg:py-20 py-12">
              <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="lg:mb-16 mb-10">
                  <h6 class="text-lg text-emerald-600 font-medium text-center mb-2 leading-7">
                    FAQs
                  </h6>
                  <h2 class="lg:text-4xl text-3xl font-manrope text-center font-bold text-gray-900 leading-tight ">
                    {" "}
                    Frequently asked questions{" "}
                  </h2>
                </div>
                <div class="accordion-group w-full max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto">
                  <div
                    class="accordion p-6 border-b border-solid bg-gray-50 border-gray-200 transition-all duration-500 active:rounded-xl active:bg-gray-50 active:border-transparent"
                    id="basic-heading-one-general"
                  >
                    <button
                      class="accordion-toggle group  inline-flex items-center justify-between text-lg text-gray-900 font-medium leading-7 w-full transition duration-500 text-left lg:text-lg hover:text-gray-900 accordion-active:text-gray-900"
                      aria-controls="basic-collapse-one-general"
                    >
                      <h5> How can I reset my password? </h5>
                      <svg
                        class="text-gray-900 transition duration-500 group-hover:text-emerald-600 accordion-active:text-emerald-600 accordion-active:rotate-180"
                        width="24"
                        height="24"
                        viewBox="0 0 24 24"
                        fill="none"
                    ...
                    <div
                      ...
                      class="accordion-content w-full  px-0 overflow-hidden transition-[height] duration-300 pr-4 mt-3"
                      aria-labelledby="basic-heading-one-general"
                    >
                      <p class="text-base text-gray-600 font-normal leading-6">
                  ...
                  <div
                    class="accordion p-6 border-b border-solid border-gray-200 transition-all duration-500 active:rounded-xl active:bg-gray-50 active:border-transparent"
                    id="basic-heading-two-with-arrow"
                  >
                    <button
                      class="accordion-toggle group  inline-flex items-center justify-between text-base leading-8 text-gray-500 w-full transition duration-500 text-left lg:text-lg hover:text-gray-900 accordion-active:text-gray-900"
                    ...
                    <div
                      ...
                      class="accordion-content w-full hidden px-0 overflow-hidden transition-[height] duration-300 pr-4 mt-3"
                  ...
                  >
                    <button
                      class="accordion-toggle group  inline-flex items-center justify-between text-base lg:text-lg leading-8 text-gray-500 w-full transition duration-500 text-left hover:text-gray-900 accordion-active:text-gray-900"
                  ...
                  <div
                    class="accordion p-6 transition-all duration-500 active:rounded-xl active:bg-gray-50"
